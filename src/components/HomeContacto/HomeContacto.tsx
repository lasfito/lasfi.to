        ...
        >
          ...
          <div>
            ...
            <div className="mb-0 text-right">
              <button
                className="my-1 mx-[10px] h-[3rem] w-full cursor-pointer rounded-md bg-boton text-lg text-white outline-none transition duration-300 ease-out hover:translate-y-[15%]  hover:bg-hover"
                id="js26"
              >
                Enviar
              </button>
